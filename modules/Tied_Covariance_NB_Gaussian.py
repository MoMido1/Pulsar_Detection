...
class Tied_NB:
    ...
    def train(self, DTR, LTR):
        ...
        for clsno in self.difClasses:
            ...
            if len(self.cov):
                self.cov[0] += self.D[clsno].shape[1] * ML_Diag_Covariance(self.D[clsno],self.muC[clsno])
            else:
                self.cov.append(self.D[clsno].shape[1] * ML_Diag_Covariance(self.D[clsno],self.muC[clsno]))
